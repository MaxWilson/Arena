...
type Shape =
    ...
    static member inline autoWidth = mkShapeAttr "width" "auto"
    static member inline autoHeight = mkShapeAttr "height" "auto"
    ...
    static member inline onTouchStart (f: ({| target: KonvaNode |} -> 'b)) = mkShapeAttr "onTouchStart" f
    static member inline onTouchEnd (f: ({| target: KonvaNode |} -> 'b)) = mkShapeAttr "onTouchEnd" f
